...
const
  ...
  FOLDERID_UserTiles: TGUID = '{008ca0b1-55b4-4c56-b8a8-4de4b299d3be}';
...
class function TShellKnownPath.GetFolderPathUnderVista(const AFolderID: TGUID): string;
var
